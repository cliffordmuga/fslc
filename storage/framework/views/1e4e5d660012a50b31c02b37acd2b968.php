...
<label <?php echo e($attributes->merge(['class' => 'block font-medium text-sm text-neutral-700'])); ?>>
    <?php echo e($value ?? $slot); ?>

</label>
<?php /**PATH C:\laragon\www\fslc\resources\views/components/input-label.blade.php ENDPATH**/ ?>