        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-10">
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                ...
                <form action="<?php echo e(route('newsletter.subscribe')); ?>" method="POST"
                    ...
                    <input type="hidden" name="utm_source" value="<?php echo e(request()->query('utm_source', 'newsletter')); ?>">
                    <input type="hidden" name="utm_medium" value="footer">
                    <input type="hidden" name="utm_campaign" value="lead_gen_<?php echo e(date('Y-m-d')); ?>">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.cms.brand-mark','data' => ['size' => 'md','showName' => true,'nameClass' => 'text-base font-bold text-white tracking-tight']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['size' => 'md','show-name' => true,'name-class' => 'text-base font-bold text-white tracking-tight']); ?>
...
<?php endif; ?>
                ...
                <p class="text-xs text-neutral-500 leading-relaxed max-w-xs">
                    <?php echo e(setting('company_tagline', 'High-performance digital solutions for ambitious brands in Kenya and beyond.')); ?>

                </p>
                <div class="flex gap-2 mt-5">
                    <?php $__currentLoopData = config('social.footer_links', []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $social): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if(setting($key)): ?>
                            <a href="<?php echo e(setting($key)); ?>" target="_blank" rel="noopener noreferrer"
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <?php $__currentLoopData = ['home' => 'Home', 'about' => 'About', 'portfolio.index' => 'Portfolio', 'services.index' => 'Services', 'insights.index' => 'Insights', 'contact' => 'Contact']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li>
                            <a href="<?php echo e(route($r)); ?>" class="text-xs text-neutral-500 hover:text-white transition-colors">
                                <?php echo e($label); ?>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <?php $__currentLoopData = config('forefront.footer_service_links', []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slug => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li>
                            <a href="<?php echo e(route('services.show', $slug)); ?>" class="text-xs text-neutral-500 hover:text-white transition-colors">
                                <?php echo e($label); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.cms.contact-link','data' => ['type' => 'email','value' => setting('email'),'class' => 'flex items-center gap-2 text-xs text-neutral-500 hover:text-white transition-colors']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'email','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(setting('email')),'class' => 'flex items-center gap-2 text-xs text-neutral-500 hover:text-white transition-colors']); ?>
...
<?php endif; ?>
                    <?php if (isset($component)) { $__componentOriginala62357e812019a65fd8af6b87ca239b2 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginala62357e812019a65fd8af6b87ca239b2 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.cms.contact-link','data' => ['type' => 'tel','value' => setting('phone'),'class' => 'flex items-center gap-2 text-xs text-neutral-500 hover:text-white transition-colors']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('cms.contact-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'tel','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(setting('phone')),'class' => 'flex items-center gap-2 text-xs text-neutral-500 hover:text-white transition-colors']); ?>
                        <svg class="w-3.5 h-3.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
...
<?php unset($__componentOriginala62357e812019a65fd8af6b87ca239b2); ?>
<?php endif; ?>
                    <a href="<?php echo e(route('contact', ['inquiry_type' => 'hmis-demo'])); ?>#contact-form"
                       class="flex items-center gap-2 text-xs text-neutral-500 hover:text-white transition-colors">
                        Request HMIS Demo
                    </a>
                    <a href="<?php echo e(route('contact', ['inquiry_type' => 'hmis-checklist'])); ?>#contact-form"
                       class="flex items-center gap-2 text-xs text-neutral-500 hover:text-white transition-colors">
                        Get HMIS Checklist
                    </a>
                </div>
        ...
        <div class="border-t border-neutral-800 mt-10 pt-6 flex flex-col sm:flex-row justify-between items-center gap-4 text-xs text-neutral-600">
            <p>© <?php echo e(date('Y')); ?> <?php echo e(config('app.name', env('APP_NAME', 'App'))); ?>. All rights reserved.</p>
            <div class="flex gap-5">
                <a href="<?php echo e(route('privacy')); ?>" class="hover:text-white transition-colors">Privacy</a>
                <a href="<?php echo e(route('terms')); ?>" class="hover:text-white transition-colors">Terms</a>
                <a href="<?php echo e(route('sitemap')); ?>" class="hover:text-white transition-colors">Sitemap</a>
            </div>
        </div>
    </div>
</footer>
<?php /**PATH C:\laragon\www\fslc\resources\views/components/layout/site-footer.blade.php ENDPATH**/ ?>