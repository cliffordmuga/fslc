        ...
        <div style="background:#ffffff;border:1px solid #e5e7eb;border-radius:16px;overflow:hidden;">
            ...
            <div style="padding:20px 22px;background:linear-gradient(135deg,#0ea5e9,#2563eb);color:#fff;">
                ...
                <div style="font-size:22px;font-weight:800;line-height:1.2;margin-top:6px;">
                    <?php echo e(ucfirst($lead->inquiry_type ?? 'general')); ?> inquiry
                </div>

                <div style="font-size:14px;opacity:.95;margin-top:8px;">
                    Submitted: <?php echo e(optional($lead->created_at)->format('D, M j, Y g:i A')); ?>
            ...
            <div style="padding:22px;">
                ...
                <div style="display:flex;gap:10px;flex-wrap:wrap;margin-bottom:16px;">
                    ...
                    <?php if(!empty($whatsAppDigits)): ?>
                        <a href="https://wa.me/<?php echo e($whatsAppDigits); ?>"
                ...
                <?php if(!empty($lead->attachment_path)): ?>
                    <div style="margin-top:14px;font-size:13px;color:#6b7280;line-height:1.6;">
                        ...
                        <?php echo e($lead->attachment_original_name ?: 'Uploaded file'); ?>
                ...
                <div style="margin-top:18px;font-size:12px;color:#6b7280;line-height:1.6;">
                    <div>
                        ...
                        <?php echo e($lead->source_content_id ?? '—'); ?>

                    </div>
                    <div><strong style="color:#111827;">UTM Source:</strong> <?php echo e($lead->utm_source ?? '—'); ?></div>
                    <div><strong style="color:#111827;">UTM Medium:</strong> <?php echo e($lead->utm_medium ?? '—'); ?></div>
                    <div><strong style="color:#111827;">UTM Campaign:</strong> <?php echo e($lead->utm_campaign ?? '—'); ?></div>
                    <div><strong style="color:#111827;">Referrer:</strong> <?php echo e($lead->referrer ?? '—'); ?></div>
                </div>
            </div>
            ...
            <div
                ...
                Tip: hit “Reply” — set your mailable to use <strong>Reply-To: <?php echo e($lead->email); ?></strong> so replies
...
<?php /**PATH C:\laragon\www\fslc\resources\views/emails/contact-received.blade.php ENDPATH**/ ?>