{{-- resources/views/components/cms/flash-messages.blade.php --}}
@php
...
{{--
    IMPORTANT: Inject PHP data via a <script> tag, NOT inside x-data="..."
    @json() emits raw JSON double-quotes which break HTML attribute parsing,
    causing raw Alpine markup to appear as visible text on the page.
--}}
<script>
    window.__flashMessages = @json($flashMessages, JSON_HEX_QUOT | JSON_HEX_TAG);
</script>
...
<div
    ...
    <template x-for="(msg, index) in messages" :key="msg.id">
        <div
            ...
            {{-- Auto-dismiss progress bar (only on top message) --}}
