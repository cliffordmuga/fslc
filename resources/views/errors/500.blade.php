...
<div class="text-center max-w-md">
    <p class="text-7xl font-black font-mono text-neutral-200 mb-4 tracking-tighter">500</p>
    <div class="w-12 h-1 bg-primary-500 mx-auto mb-6"></div>
    <h1 class="text-2xl md:text-3xl font-black text-neutral-900 mb-3 tracking-tight">Something Went Wrong</h1>
